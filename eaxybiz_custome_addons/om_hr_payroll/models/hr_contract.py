...
class HrContract(models.Model):
    ...
    # contract_remarks = fields.Text(string='Contract Remarks',
    #                                default='ESI field will be enabled if An employee CTC below Rs.21000,'
    #                                        'PF Fixed Amount will set as Rs.1800 '
    #                                        'if an employee receives CTC Rs.15000 & above.')
